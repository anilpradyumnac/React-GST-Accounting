        ...
        U = function() {
            ...
            for (var c = h.getElementsByTagName(R), d = 0, e = c.length; d < e; ++d) {
                ...
                if (f.src && (a = String(f.nonce || f.getAttribute("nonce") || "") || null)) {
                    ...
                    if (l !== k && a &&
                        a === String(a) && a.match(S)) return A.nonce = a
                }
            }
            return null
        },
...
gapi.load("", {
    ...
    _c: {
        "jsl": {
            ...
            "h": "m;/_/scs/apps-static/_/js/k\u003doz.gapi.en_GB.SnABPq2aAf4.O/m\u003d__features__/am\u003dAQ/rt\u003dj/d\u003d1/rs\u003dAGLTcCPKkAldJZBDPZZcO-FVPXAQtnMr4Q",
            "u": "https://apis.google.com/js/api.js",
            "hee": true,
            "fp": "0211963e1fe8faa9cdebc992b134547333116f9f",
            "dpo": false
        },
        "fp": "0211963e1fe8faa9cdebc992b134547333116f9f",
